...
public class OperationFactoryDup
extends OperationFactoryDupBase {
    ...
    public StackDelta getStackDelta(JVMInstr instr, byte[] data, ConstantPoolEntry[] cpEntries, StackSim stackSim, Method method) {
        StackTypes popped = OperationFactoryDup.getStackTypes((StackSim)stackSim, (Integer[])new Integer[]{0});
        StackTypes pushed = OperationFactoryDup.getStackTypes((StackSim)stackSim, (Integer[])new Integer[]{0, 0});
