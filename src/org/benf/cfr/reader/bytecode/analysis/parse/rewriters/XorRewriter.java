...
public class XorRewriter
implements ExpressionRewriter {
    @Override
    public Expression rewriteExpression(Expression expression, SSAIdentifiers ssaIdentifiers, StatementContainer statementContainer, ExpressionRewriterFlags flags) {
        ArithmeticOperation arithmeticOperation;
        if (!(expression instanceof ArithmeticOperation) || !(arithmeticOperation = (ArithmeticOperation)expression).isXorM1()) return expression.applyExpressionRewriter(this, ssaIdentifiers, statementContainer, flags);
